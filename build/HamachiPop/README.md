...
- 手動で調整、改変したグリフ: 0 " ' , . ; : | (半角)、０ ， ． ； ： 敲 寂 ローマ数字 (全角)
...
[SIL Open Font License Version 1.1](https://github.com/omonomo/JPMonoFonts/blob/main/build/HamachiPop/OFL.txt)

## 謝辞

Hamachi Pop の製作にあたり、素晴らしいフォントやツール類を提供してくださっております製作者の方々に感謝いたします。
